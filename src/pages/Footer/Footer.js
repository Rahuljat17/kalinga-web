                ...
                <div className="footer-main-body">
                    <div className="foot-main-body-header">
                        <div className="footer-mobile-side">
                            <div>
                                ...
                                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "flex-start", gap: "10px" }}>
                                    ...
                                    <h3 className="footer-title">Kalinga Cables and Conduit Co. Sector 29<br />Village Jatjoshi, Delhi-Sonipat road, chowk,<br />near Bahalgarh, Sonipat, Haryana 131001</h3>
                                </div>
                            </div>
                            {/*  */}
                        ...
                        <div className="footer-mobile-side">
                            ...
                            {/*  */}
                            <div className="foot-netwoek-main">
                                <h3 className="foot-our-network ccc">Join Our Team</h3>
                            </div>
                            {/*  */}
